        ...
        <div className="md:col-span-2 grid items-start gap-3">
          <div className="space-y-4">
            <iframe
              ...
              src={`https://www.youtube.com/embed/aLAKJu9aJys?si=STCeafa8nv5BAykF`}
          ...
          <p className="leading-7 text-muted-foreground">
            ...
            embalmed hand, they become hooked on the new thrill, until one of
            them goes too far and unleashes terrifying supernatural forces.
          </p>
        </div>
                  ...
                  <div className="space-y-8 text-secondary-foreground mt-2">
                    <div className="flex">
                      ...
                      <div className="ml-4 space-y-1">
                        <p className="text-sm font-medium leading-5">
                          ...
                          knocked it out of the park and so did zoe terakes and
                          chris alosio. some particular scenes with riley were
                          were insane. the ending left me feeling empty yet
                          wanting more. really hoping for a sequel because this
                          cast had some impeccable chemistry. really wish this
                          movie could have made it to the two hour mark because
                          it was amazing. an amazing directorial debut for the
                          racka racka brothers hope they do more horror movies
                        </p>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4 space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground">jackson</p>
                      </div>
                    </div>
                    <div className="flex">
                      <Avatar className="flex h-9 w-9 items-center justify-center space-y-0 border">
